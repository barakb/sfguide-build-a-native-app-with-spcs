...
build: build_backend build_frontend build_router build_falkordb  ## Build Docker images for Snowpark Container Services
...
push: push_backend push_frontend push_router push_falkordb     ## Push Docker images to Snowpark Container Services
...
clean:           ## Remove local Docker images
	docker rmi -f $(BACKEND_IMAGE) $(FRONTEND_IMAGE) $(ROUTER_IMAGE) $(FALKORDB_IMAGE) 2>/dev/null || true
